...
const Settings: FunctionComponent = () => {
  return (
    <div className="relative bg-gray-scale-white w-full h-[2420px] overflow-hidden text-left text-sm text-gray-scale-gray-900 font-body-small-body-small-400">
      <div className="absolute top-[1461px] left-[636px] w-[984px] h-[349px]">
      ...
      <div className="absolute top-[347px] left-[636px] w-[984px] h-[533px]">
      ...
      <div className="absolute top-[347px] left-[300px] rounded-lg bg-gray-scale-white flex flex-col items-start justify-start pt-0 px-0 pb-3 text-base text-gray-scale-gray-600 border-[1px] border-solid border-gray-scale-gray-100">
      ...
      <div className="absolute top-[904px] left-[636px] w-[984px] h-[533px]">
        <div className="absolute top-[-1px] left-[-1px] rounded-lg bg-gray-scale-white box-border w-[986px] h-[535px] border-[1px] border-solid border-gray-scale-gray-100" />
        <div className="absolute top-[464px] left-[24px] rounded-24xl bg-branding-success flex flex-row items-center justify-center py-3.5 px-8 text-gray-scale-white">
          <div className="relative leading-[120%] font-semibold">
            Save Changes
      ...
      <div className="absolute top-[1890px] left-[0px] flex flex-col items-start justify-start text-5xl">
