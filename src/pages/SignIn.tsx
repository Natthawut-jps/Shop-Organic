...
const SignIn: FunctionComponent = () => {
  return (
    <div className="relative bg-gray-scale-white w-full h-[1376px] overflow-hidden text-left text-sm text-gray-scale-gray-900 font-heading-05-heading-05-600">
      <div className="absolute top-[395px] left-[700px] rounded-lg bg-gray-scale-white shadow-[0px_0px_56px_rgba(0,_38,_3,_0.08)] flex flex-col items-center justify-start pt-6 px-6 pb-8 gap-[20px] border-[1px] border-solid border-gray-scale-gray-50">
        ...
        <div className="flex flex-col items-start justify-start gap-[16px] text-base text-gray-scale-gray-400">
          <div className="flex flex-col items-start justify-start gap-[12px]">
            <div className="rounded-md bg-gray-scale-white flex flex-row items-center justify-center py-3.5 px-4 border-[1px] border-solid border-gray-scale-gray-100">
              <div className="relative leading-[130%] inline-block w-[440px] shrink-0">
                Email
              </div>
            </div>
            <div className="rounded-md bg-gray-scale-white flex flex-row items-center justify-start py-3.5 px-4 border-[1px] border-solid border-gray-scale-gray-100">
              <div className="relative leading-[130%] inline-block w-[420px] shrink-0">
                Password
              </div>
              <img
          ...
          <div className="w-[472px] flex flex-row items-start justify-between text-sm text-gray-scale-gray-600">
            ...
            <div className="relative leading-[150%]">Forget Password</div>
          </div>
        </div>
        <div className="rounded-24xl bg-branding-success w-[472px] flex flex-row items-center justify-center py-3.5 px-8 box-border text-gray-scale-white">
      ...
      <div className="absolute top-[846px] left-[0px] flex flex-col items-start justify-start text-5xl">
