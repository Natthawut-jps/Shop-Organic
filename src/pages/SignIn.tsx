        ...
        <DialogContent className="relative bg-gray-scale-white top-0 left-0 right-0 bottom-0 shadow-[0px_0px_56px_rgba(0,_38,_3,_0.08)] text-left text-sm text-gray-scale-gray-900 font-heading-05-heading-05-600">
          <div className=" relative rounded-lg bg-gray-scale-white  flex flex-col items-center justify-start pt-6 px-6 pb-8 gap-[20px]  ">
            <div className=" absolute box-border top-0 right-0">
              <FontAwesomeIcon onClick={() => props.SignIn.setOpenSignIn(false)} icon={faXmark} size="lg" className="cursor-pointer p-[5px] opacity-50 active:bg-slate-300 active:bg-opacity-60 float-right " />
            </div>
              ...
              <div className="flex flex-col items-start justify-start gap-[12px]">
                <div className="rounded-md bg-gray-scale-white flex flex-row items-center justify-center border-[1px] border-solid border-gray-scale-gray-100">
                  <div className="relative leading-[130%] inline-block w-[440px] h-[40px] shrink-0">
                    <input form="passwordEyeForm" type="email" placeholder="Email" className="text-[#373636] relative bg-transparent focus:outline-none text-[16px] left-[10px] w-[424px] rounded-lg h-[37px] shrink-0" required />
                  </div>
                </div>
                <div className="rounded-md bg-gray-scale-white flex flex-row items-center justify-start border-[1px] border-solid border-gray-scale-gray-100">
                  <div className="relative leading-[130%] inline-block w-[440px] h-[40px] shrink-0">
                    <input form="passwordEyeForm" type="password" id="passwordSignIn" placeholder="Password" className="text-[#373636] relative bg-transparent focus:outline-none text-[16px] left-[10px] w-[380px] h-[37px] rounded-lg shrink-0" required />
                  </div>
                  {passEye ?
                    <Visibility onClick={passwordEye} fontSize="small" sx={{ color: 'black' }} className=" cursor-pointer absolute right-[75px] w-5 h-5 overflow-hidden shrink-0" />
                    :
                    <VisibilityOff onClick={passwordEye} fontSize="small" sx={{ color: 'black' }} className="cursor-pointer absolute right-[75px] w-5 h-5 overflow-hidden shrink-0" />
                  }
                </div>
              </div>
              <div className="w-[472px] flex flex-row items-center justify-between text-sm text-gray-scale-gray-600">
                <div className="flex flex-row items-center justify-center relative left-4 gap-[6px]">
                  <div className="relative w-5 h-5">
                    <input type="checkbox" className=" absolute top-[-4px] cursor-pointer h-full w-full rounded-10xs bg-gray-scale-white box-border border-[1px] border-solid border-gray-scale-gray-200" />
                  </div>
                  <div className="relative left-2 leading-[150%]">Remember me</div>
                </div>
                <Link to={''} className=" right-7 no-underline text-black relative leading-[150%]">Forget Password</Link>
              </div>
            </div>
