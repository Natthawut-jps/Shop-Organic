...
const CreateAccount: FunctionComponent = () => {
  return (
    <div className="relative bg-gray-scale-white w-full h-[1437px] overflow-hidden text-left text-sm text-gray-scale-gray-900 font-body-small-body-small-400">
      <div className="absolute top-[395px] left-[700px] rounded-lg bg-gray-scale-white shadow-[0px_0px_56px_rgba(0,_38,_3,_0.08)] flex flex-col items-center justify-center pt-6 px-6 pb-8 gap-[20px] border-[1px] border-solid border-gray-scale-gray-50">
      ...
      <div className="absolute top-[907px] left-[0px] flex flex-col items-start justify-start text-5xl">
