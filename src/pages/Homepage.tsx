...
const Homepage: FunctionComponent = () => {
  return (
    <div className="relative bg-gray-scale-white w-full h-[5574px] overflow-hidden text-left text-sm text-gray-100 font-body-tiny-body-tiny-400">
      {/* 12 */}
      <div className="absolute top-[5044px] left-[-150px] flex flex-col items-start justify-start text-5xl">
        ...
        <div className=" bg-gray-100 flex flex-col items-start justify-center pt-[60px] px-[300px] pb-0 gap-[60px] text-base text-gray-scale-white">
          <div className="relative w-[1248px] h-[168px]">
            <div className="absolute h-[98.81%] w-[26.92%] top-[1.19%] right-[73.08%] bottom-[0%] left-[0%] flex flex-col items-start justify-start gap-[16px] text-sm">
              <a href="#" className=" text-white no-underline flex flex-row items-center justify-start gap-[8px] text-13xl">
                <img
            ...
            <div className="absolute h-[97.62%] w-[7.61%] top-[0%] right-[56.49%] bottom-[2.38%] left-[35.9%] flex flex-col items-start justify-start gap-[20px]">
              <a href="#" className=" text-white no-underline relative leading-[150%] font-medium">
                My Account
              </a>
            ...
            <div className="absolute h-[97.62%] w-[10.42%] top-[0%] right-[35.74%] bottom-[2.38%] left-[53.85%] flex flex-col items-start justify-start gap-[20px]">
              <a href="#" className=" text-white no-underline relative leading-[150%] font-medium">Helps</a>
              <div className="flex flex-col items-start justify-start gap-[12px] text-sm text-gray-scale-gray-400">
            ...
            <div className="absolute h-[97.62%] w-[6.57%] top-[0%] right-[21.55%] bottom-[2.38%] left-[71.88%] flex flex-col items-start justify-start gap-[20px]">
              <a href="#" className="text-white no-underline relative leading-[150%] font-medium">Proxy</a>
              <div className="flex flex-col items-start justify-start gap-[12px] text-sm text-gray-scale-gray-400">
      ...
      <div className="absolute top-[1608px] left-[130px] w-[1320px] h-[714px] text-gray-scale-gray-700">
        ...
        <a href="#" className="hover:shadow-[0px_0px_12px_rgba(32,_181,_38,_0.32)]  hover:text-branding-success-dark text-gray-100 hover:border-branding-success-dark absolute top-[59px] left-[0px] bg-gray-scale-white box-border w-[265px] h-[328px] border-[1px] border-solid border-gray-scale-gray-100">
          <div className="absolute h-[73.17%] w-[99.62%] top-[0%] right-[0.38%] bottom-[26.83%] left-[0%] flex flex-col items-start justify-start p-[5px] box-border">
            <img
              className="relative w-[254px] h-[230px] object-cover"
              alt=""
      ...
      <div className="absolute top-[0px] left-[-180px] bg-gray-scale-white h-[195px] flex flex-col items-center justify-start text-xs text-gray-scale-gray-600">
        ...
        <div className="bg-gray-scale-gray-800 w-[1920px] flex flex-row items-center justify-between py-4 px-[300px] box-border text-sm text-gray-scale-gray-400">
          <div className="flex flex-row items-center justify-start gap-[32px]">
            <div className="flex flex-row items-center justify-start gap-[4px] text-gray-scale-white">
