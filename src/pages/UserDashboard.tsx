...
const UserDashboard: FunctionComponent = () => {
  return (
    <div className="relative bg-gray-scale-white w-full h-[1663px] overflow-hidden text-left text-base text-gray-scale-gray-900 font-caps-lock-small-caps-lock">
      <div className="absolute top-[347px] left-[1196px] w-[424px] h-[278px] text-gray-scale-gray-400">
      ...
      <div className="absolute top-[649px] left-[636px] w-[984px] h-[404px] text-xs text-gray-scale-gray-700">
      ...
      <div className="absolute top-[347px] left-[636px] w-[536px] h-[278px] text-center text-xl">
      ...
      <div className="absolute top-[347px] left-[300px] rounded-lg bg-gray-scale-white flex flex-col items-start justify-start pt-0 px-0 pb-3 text-gray-scale-gray-600 border-[1px] border-solid border-gray-scale-gray-100">
        ...
        <div className="flex flex-row items-center justify-center py-4 px-5 gap-[10px]">
          <img className="relative w-6 h-6" alt="" src="/dashboard-23.svg" />
          <div className="relative leading-[150%] inline-block w-[238px] shrink-0">
            Shopping Cart
          </div>
        </div>
      ...
      <div className="absolute top-[1133px] left-[0px] flex flex-col items-start justify-start text-5xl">
