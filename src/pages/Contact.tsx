...
const Contact: FunctionComponent = () => {
  return (
    <div className="relative bg-gray-scale-white w-full h-[1912px] overflow-hidden text-left text-base text-gray-scale-gray-900 font-body-small-body-small-400">
      <img
        className="absolute top-[982px] left-[0px] w-[1920px] h-[400px] object-cover"
        alt=""
        src="/map-image@2x.png"
      />
      <div className="absolute top-[395px] left-[636px] w-[984px] h-[507px]">
        ...
        <div className="absolute top-[406px] left-[50px] rounded-24xl bg-branding-success flex flex-row items-center justify-center py-4 px-10 text-gray-scale-white">
          <div className="relative leading-[120%] font-semibold">
            Send Message
          </div>
        </div>
        <div className="absolute top-[284px] left-[50px] rounded-md bg-gray-scale-white box-border w-[884px] h-[98px] text-gray-scale-gray-400 border-[1px] border-solid border-gray-scale-gray-100">
          <div className="absolute top-[14px] left-[16px] leading-[130%]">
            Subjects
          </div>
        </div>
        <div className="absolute top-[219px] left-[50px] rounded-md bg-gray-scale-white box-border w-[884px] h-[49px] border-[1px] border-solid border-branding-success">
          <div className="absolute top-[14px] left-[16px] leading-[130%]">
            Hello|
          </div>
        </div>
        <div className="absolute top-[154px] left-[500px] rounded-md bg-gray-scale-white box-border w-[434px] h-[49px] text-gray-scale-gray-600 border-[1px] border-solid border-gray-scale-gray-100">
          <div className="absolute top-[14px] left-[16px] leading-[130%]">
            zakirsoft@gmail.com
          </div>
        </div>
        <div className="absolute top-[154px] left-[50px] rounded-md bg-gray-scale-white box-border w-[434px] h-[49px] text-gray-scale-gray-600 border-[1px] border-solid border-gray-scale-gray-100">
          <div className="absolute top-[14px] left-[16px] leading-[130%]">
            Template Cookie
          </div>
        </div>
      ...
      <div className="absolute top-[395px] left-[300px] rounded-lg bg-gray-scale-white shadow-[0px_0px_56px_rgba(0,_38,_3,_0.08)] flex flex-col items-start justify-start py-0 px-5 text-center text-gray-scale-gray-800">
      ...
      <div className="absolute top-[0px] left-[0px] bg-gray-scale-white flex flex-col items-center justify-start text-xs text-gray-scale-gray-300">
        <div className="bg-gray-scale-gray-800 shadow-[0px_1px_0px_#e5e5e5] w-[1920px] flex flex-row items-center justify-between py-3 px-[300px] box-border">
          <div className="flex flex-row items-center justify-start gap-[8px]">
            <img className="relative w-4 h-[19px]" alt="" src="/map-pin1.svg" />
      ...
      <div className="absolute top-[1382px] left-[0px] flex flex-col items-start justify-start text-5xl">
