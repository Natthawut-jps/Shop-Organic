          ...
          <div className="bg-white box-border w-full grid grid-flow-row justify-items-center">
            ...
            {cartItems.length > 0 &&
              cartItems.map((item) => (
                <div
                  key={item.id}
                  className="flex flex-initial relative top-[40px] w-full h-[96px] gap-5"
                >
                    ...
                    <div className=" relative w-[87px] h-[31px]">
                      <div className="relative w-[81px] h-[31px] bg-[#ffffff33] rounded-[4px] border border-solid border-[#33343566]">
                        ...
                        >
                          <FontAwesomeIcon
                            icon={faPlus}
                            className="relative top-[8px] left-[10px]"
                          />
                        </div>
                        ...
                        >
                          <FontAwesomeIcon
                            icon={faMinus}
                            className=" relative top-[7px] left-2"
                          />
                        </div>
                      </div>
                    </div>
            ...
            {cartItems.length > 0 ? (
              <div className=" relative w-full pb-[320px] box-border top-[60px] bg-[#f7f7f7]">
                ...
                <div
                  onClick={() => props.Carts.setOpenCart(false)}
                  className=" cursor-pointer top-[229px] left-[128px] [font-family:'Noto_Serif_Thai',Helvetica] font-normal text-black text-[14px] absolute tracking-[0] leading-[normal]"
                >
                  ช้อปปิ้งต่อ
                </div>
              </div>
